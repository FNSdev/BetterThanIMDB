...
{
    class SearchProducersPageViewModel : BaseViewModel
    {
        ...
        public SearchProducersPageViewModel(ProducersPageViewModel vm)
        {
            ...
            ApplyCommand = new Command(async () =>
            {
                ...
                {
                    vm.Producers = new CustomObservableCollection<Producer>(ProducerCollection.Instance.Producers.Where(a => a.Name.ToLower().Contains(Name.ToLower())).
